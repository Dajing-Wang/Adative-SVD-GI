...
%% intialization
% This is main-function of paper entitled "Dual-mode adaptive-SVD ghost imaging"
% Applied paramters of simulation results shown in our paper are as following:
% test_image1 & 2: total resolution of 128*128; superpixel size: 2*2
% test_image3: total resolution of 128*128; superpixel size: 4*4
...
index_notready = [];
[index_notready(:,1),index_notready(:,2)] = find(result_pre>=K_1);
